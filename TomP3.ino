...
/**
 * \brief Macro for the debounced NEXT pin, with pull-up
 */
#define B_NEXT  A0

/**
 * \brief Macro for the debounced STOP pin, with pull-up
 */
#define B_STOP  A1

/**
 * \brief Macro for the debounced PLAY pin, with pull-up
 */
#define B_PLAY  A2

/**
 * \brief Macro for the Debounce Period [milliseconds]
 */
